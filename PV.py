...
def find_roof_area():
    ...
    #math.cos(math.radians(roof_angle) would probably be faster
...
print("Each panel is {:.2f} square meters.".format(panelArea))

print("The roof will fit {} panels and deliver {:.2f} kw.\n".format(numPanels, powerDelivered))